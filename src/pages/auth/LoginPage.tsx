...
const LoginPage = () => {
    ...
    const schema: ZodType<LoginData> = z.object({
        ...
        password: z
            .string()
            .min(5, 'Password must have least of 5 characters')
            .max(20, 'Password cant exceed 20 characters'),
    });
    const {
        register,
        handleSubmit,
    ...
    return (
        <AuthLayout>
            <form
                ...
                className=" flex flex-col gap-4 w-full max-w-[371px]">
                <div className="flex flex-col gap-2 text-center lg:text-left">
                    <h1 className="text-[25px] md:text-[30px] lg:text-[36px] font-medium">
                        Log in to Exclusive
                    </h1>
          ...
          >
            LogIn
                    ...
                    />
                    <h2 className="font-normal text-[16px] text-[#DB4444]">
                        forgot password ?
                    </h2>
                </div>
                <div className="flex items-center  w-[248px] mx-auto gap-2">
                    ...
                    <Link to="/signup">
                        <p className="font-normal text-[16px] cursor-pointer">sign-up</p>
                    </Link>
                </div>
            </form>
        </AuthLayout>
